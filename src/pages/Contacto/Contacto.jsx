            ...
            <div className='Redes-wrapper'>
                <ul className='Redes-ul'>
                    <li className='Redes-li'>
                        <a className='Redes-a' href='https://www.linkedin.com/in/luismisg/' target='_blank' title='Perfil de Linkedin'>
                            <p>LINKEDIN</p>
                            <svg xmlns="http://www.w3.org/2000/svg" class="Redes-icon" viewBox="0 0 16 16">
                    ...
                    <li className='Redes-li'>
                        <a className='Redes-a' href='https://github.com/luismi-sg' target='_blank' title='Perfil de Github'>
                            <p>GITHUB</p>
                            <svg xmlns="http://www.w3.org/2000/svg" class="Redes-icon" viewBox="0 0 16 16">
                    ...
                    <li className='Redes-li'>
                        <a className='Redes-a' href='mailto:lmsg1191@gmail.com' target='_blank' title='Enviar un correo'>
                            <p>EMAIL</p>
                            <svg xmlns="http://www.w3.org/2000/svg" class="Redes-icon" viewBox="0 0 16 16">
