                        ...
                        <div className="grid-container mobile">
                            <div className='Info-wrapper'>
                                ...
                                <h4 className='Info-h4'>FrontEnd Developer & UXUI Designer</h4>
                                    <p>Me llaman LuisMi. Soy desarrollador FrontEnd y diseñador UX/UI con un máster en Diseño y Desarrollo Web. Me dedico a la creación y mejora constante de proyectos en el área del diseño, especialmente relacionados con el diseño de webs, apps e interfaces en general. Me destaco por diseñar sistemas modernos y funcionales, aplicando buenas prácticas como el Atomic Design y el Pixel Perfect. Acostumbrado a trabajo en entornos con metodologías ágiles.</p>
                                {/* <ul>
                        ...
                        <div className="grid-container">
                            <div className='Redes-wrapper'>
                                <ul className='Redes-ul'>
                                    <li className='Redes-li hand'>
                                        <picture className='Redes-a contacto hand'>
                                            <img className='Icon-svg' src="/assets/hand.svg" alt="Icono mano" />
                                        </picture>
                                    </li>
                                    <li className='Redes-li'>
                                        <a className='Redes-a contacto' href='https://www.linkedin.com/in/luismisg/' target='_blank' title='Perfil de Linkedin'>
                                    ...
                                    <li className='Redes-li'>
                                        <a className='Redes-a contacto' href='https://github.com/luismi-sg' target='_blank' title='Perfil de Github'>
                                            <svg xmlns="http://www.w3.org/2000/svg" className="Redes-icon" viewBox="0 0 16 16">
                                    ...
                                    <li className='Redes-li'>
                                        <a className='Redes-a contacto' href='mailto:lmsg1191@gmail.com' target='_blank' title='Enviar un correo'>
                                            <svg xmlns="http://www.w3.org/2000/svg" className="Redes-icon" viewBox="0 0 16 16">
